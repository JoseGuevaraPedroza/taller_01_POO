...
public class CalculadoraEstadisticas
{
	...
	/*Opciones para el taller 1*/
	public String[] buscar_atleta_por_nombre(String nombre)
	{
		String[] resultado = new String[2];
		Atleta atleta_= buscarAtleta(nombre);
		resultado[0]=atleta_.darNombre();
		resultado[1]=atleta_.darPais().darNombre();
		return resultado;
	}
