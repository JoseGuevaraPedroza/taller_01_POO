...
public class ConsolaOlimpicos
{
	...
	public void ejecutarAplicacion()
	{
		...
		while (continuar)
		{
			try
			{
				...
				else if (opcion_seleccionada == 0 && calculadora != null)
					atleta_por_nombre();
	...
	public void mostrarMenu()
	{
		...
		System.out.println("0. Consultar atleta por nombre");
	...
	private void atleta_por_nombre() 
	{
		String nombre = input("Ingrese el nombre del atleta que desea buscar");
		String[] datos= calculadora.buscar_atleta_por_nombre(nombre);
		
		if (datos != null) {
			System.out.println("Nombre del atleta: "+datos[0]);
			System.out.println("Pais al que pertenece: "+datos[1]);
		}
	}
